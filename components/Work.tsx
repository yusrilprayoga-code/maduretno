      ...
      <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
        <div className="hidden md:block mb-24 md:mb-0 sm:px-6">
          <div className="relative">
            <h1 className="text-3xl mb-8 text-gray-800 font-bold lg:text-4xl">
          ...
          <blockquote className="relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl font-medium italic text-gray-800 md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                " Selamat datang di Desa Maduretno, Kecamatan Buluspesantren,
                Kabupaten Kebumen, Provinsi Jawa Tengah. Semoga dengan adanya
                website ini, masyarakat Desa Maduretno dapat lebih mudah dalam
                mendapatkan informasi seputar desa kami. Terima kasih atas
                kunjungannya. Wassalamu'alaikum Warahmatullahi Wabarakatuh. "
              </p>
            </div>
